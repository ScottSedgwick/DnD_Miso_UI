  ...
  [ H.table_ [ MC.style_ [ MC.width "100%" ] ]
    [ H.tr_ [MC.style_ [ MC.width "100%" ] ]
      [ H.td_ [ MC.style_ [ MC.width "25%" ] ]
        [ H.label_ [ P.class_ "label", P.for_ "spellFilterTitle" ] [ "Name" ]
      ...
      , H.td_ [ MC.style_ [ MC.width "25%" ] ]
        [ H.label_ [ P.class_ "label", P.for_ "spellFilterSchool" ] [ "School" ]
      ...
      , H.td_ [ MC.style_ [ MC.width "25%" ] ]
        [ H.label_ [ P.class_ "label", P.for_ "spellFilterLevel" ] [ "Level" ]
      ...
      , H.td_ [ MC.style_ [ MC.width "25%" ] ]
        [ H.label_ [ P.class_ "label", P.for_ "spellFilterList" ] [ "Class" ]
...
sourceView s =
  [ H.table_ [ MC.style_ [ MC.width "100%" ] ]
    [ H.tr_ [ MC.style_ [ MC.width "100%" ] ]
      [ H.td_ [ MC.style_ [ MC.width "20%" ] ] [ H.strong_ [] [ text "Casting Time" ] ]
      , H.td_ [ MC.style_ [ MC.width "20%" ] ] [ H.strong_ [] [ text "Range" ] ]
      , H.td_ [ MC.style_ [ MC.width "20%" ] ] [ H.strong_ [] [ text "Components" ] ]
      , H.td_ [ MC.style_ [ MC.width "20%" ] ] [ H.strong_ [] [ text "Duration" ] ]
      , H.td_ [ MC.style_ [ MC.width "20%" ] ] [ H.strong_ [] [ text "Source" ] ]
      ]
    , H.tr_ [ MC.style_ [ MC.width "100%" ] ]
      [ H.td_ [ MC.style_ [ MC.width "20%" ] ] [ text (ms $ s ^. castingTime) ]
      , H.td_ [ MC.style_ [ MC.width "20%" ] ] [ text (ms $ s ^. range) ]
      , H.td_ [ MC.style_ [ MC.width "20%" ] ] [ text (ms $ s ^. components) ]
      , H.td_ [ MC.style_ [ MC.width "20%" ] ] [ text (ms $ s ^. duration) ]
      , H.td_ [ MC.style_ [ MC.width "20%" ] ] [ text (ms $ intercalate ", " (s ^. source)) ]
      ]
    ]
  , H.hr_ []
  ]
