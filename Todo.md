...
* Put the loaded backgrounds into the top-level model. (DONE)
* When the Backgrounds app loads the data, push it into the upstream model. (DONE)
* When the Backgrounds app is launched, pass the top-level backgrounds data in - only load if it is empty. (DONE)
